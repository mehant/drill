...
@FunctionTemplate(name = "cast${type.to?upper_case}", scope = FunctionTemplate.FunctionScope.SIMPLE_ERR, nulls=NullHandling.NULL_IF_NULL, errors = {"parsing exception", "overflow exception"})
public class Cast${type.from}${type.to} implements DrillSimpleErrFunc{

  @Param ${type.from}Holder in;
  @Output ${type.to}Holder out;

  public int setup(RecordBatch incoming) {
    return 0;
  }
