...
public class DrillSimpleErrFuncNullableHolder extends DrillBaseErrFuncHolder{
  public DrillSimpleErrFuncNullableHolder(DrillSimpleErrFuncHolder errFuncHolder) {
    super(errFuncHolder.scope, errFuncHolder.nullHandling, errFuncHolder.isBinaryCommutative, errFuncHolder.isRandom(),
          errFuncHolder.registeredNames, errFuncHolder.parameters, errFuncHolder.returnValue, errFuncHolder.workspaceVars,
          errFuncHolder.methodMap, errFuncHolder.imports);
  }
