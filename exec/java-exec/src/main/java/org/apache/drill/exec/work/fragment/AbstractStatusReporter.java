...
public abstract class AbstractStatusReporter implements StatusReporter{
  ...
  protected void running(final FragmentHandle handle, final FragmentStatus.Builder statusBuilder){
    statusChange(handle, statusBuilder.build());
  }

  protected void cancelled(final FragmentHandle handle, final FragmentStatus.Builder statusBuilder){
    statusChange(handle, statusBuilder.build());
  }

  protected void finished(final FragmentHandle handle, final FragmentStatus.Builder statusBuilder){
    statusChange(handle, statusBuilder.build());
  }
  ...
  protected void fail(final FragmentHandle handle, final FragmentStatus.Builder statusBuilder){
    statusChange(handle, statusBuilder.build());
  }
