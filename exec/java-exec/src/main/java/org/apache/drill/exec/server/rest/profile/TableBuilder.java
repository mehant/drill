...
class TableBuilder {
  ...
  SimpleDateFormat days = new SimpleDateFormat("DD'd'hh'h'mm'm'");
  SimpleDateFormat sdays = new SimpleDateFormat("DD'd'hh'h'mm'm'");
  SimpleDateFormat hours = new SimpleDateFormat("HH'h'mm'm'");
  SimpleDateFormat shours = new SimpleDateFormat("H'h'mm'm'");
  SimpleDateFormat mins = new SimpleDateFormat("mm'm'ss's'");
  SimpleDateFormat smins = new SimpleDateFormat("m'm'ss's'");

  SimpleDateFormat secs = new SimpleDateFormat("ss.SSS's'");
  SimpleDateFormat ssecs = new SimpleDateFormat("s.SSS's'");
