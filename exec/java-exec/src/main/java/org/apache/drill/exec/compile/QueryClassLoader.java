...
public class QueryClassLoader extends URLClassLoader {
  ...
  public static final OptionValidator JAVA_COMPILER_DEBUG = new BooleanValidator(JAVA_COMPILER_DEBUG_OPTION, false);
  ...
  private class ClassCompilerSelector {
    ...
    ClassCompilerSelector(DrillConfig config, OptionManager sessionOptions) {
      ...
      this.janinoClassCompiler = new JaninoClassCompiler(QueryClassLoader.this, debug);
      this.jdkClassCompiler = new JDKClassCompiler(QueryClassLoader.this, debug);
    }
