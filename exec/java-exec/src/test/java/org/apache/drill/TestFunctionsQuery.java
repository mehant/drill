...
public class TestFunctionsQuery extends BaseTestQuery {
  ...
  public void testHash64() throws Exception {
    String query = "select " +
        "hash64(cast(employee_id as int)) = hash64(cast(employee_id as bigint)) col1, " +
        "hash64(cast(employee_id as bigint)) = hash64(cast(employee_id as float)) col2, " +
        "hash64(cast(employee_id as float)) = hash64(cast(employee_id as double)) col3, " +
        "hash64(cast(employee_id as double)) = hash64(cast(employee_id as decimal(9, 0))) col4, " +
        "hash64(cast(employee_id as decimal(9, 0))) = hash64(cast(employee_id as decimal(18, 0))) col5, " +
        "hash64(cast(employee_id as decimal(18, 0))) = hash64(cast(employee_id as decimal(28, 0))) col6, " +
        "hash64(cast(employee_id as decimal(28, 0))) = hash64(cast(employee_id as decimal(38, 0))) col7 " +
        "from cp.`employee.json` where employee_id = 1";
